        ...
        <CardContent className="p-4 md:px-6 md:py-2">
          <div className="flex sm:flex-row items-start sm:items-center gap-3 md:gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-xl md:text-2xl font-semibold text-[#ffffff]">Welcome back, Kiko</h2>
              <p className='text-sm text-white'>EMP-2024-00123</p>
              <p className="text-sm md:text-base text-white">IT Officer • ICT Unit</p>
            </div>
